...
.header {
  ...
  color: white;
  text-align: center;
  box-shadow: 0 10px 40px rgba(45, 55, 72, 0.25);
  flex-shrink: 0;
}
...
.history-item.active {
  background: linear-gradient(135deg, #ebf4ff 0%, #e3efff 100%);
  border-color: #63b3ed;
...
.get-key-btn {
  ...
  color: white;
  box-shadow: 0 4px 14px rgba(237, 137, 54, 0.25);
}
